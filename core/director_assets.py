...
BUILTIN_SCENES: dict[str, dict[str, Any]] = {
    ...
    for item in (
        ...
        _scene(
            "古风叙事",
            character="说书人，沉静从容，带一点旧时光的疏离与感慨。",
            scene="茶楼角落，醒木未拍，向听客缓缓开篇。",
            guidance=(
                "语速偏慢，抑扬分明；不夸张戏腔，保持叙事感。\n"
                "- 语速与顿挫：句读清楚，可有短促顿挫。\n"
                "- 气声与实声：实声为主，感慨处略收。\n"
                "- 咬字肌理：字正，略带古意但不拗口。"
            ),
            keywords=("古风", "说书", "叙事", "武侠"),
        ),
        _scene(
            "新闻播报",
            character="新闻主播，客观、清晰、可信，不带个人情绪表演。",
            scene="直播间，镜头前播报当日要闻。",
            guidance=(
                "语速适中偏稳，吐字清晰有力；避免戏剧化起伏。\n"
                "- 语速与顿挫：节奏均匀，句末收干净。\n"
                "- 气声与实声：实声饱满。\n"
                "- 咬字肌理：准确、利落。"
            ),
            keywords=("新闻", "播报", "主播", "快讯"),
        ),
        _scene(
            "emo 独白",
            character="低落的倾诉者，敏感、内敛，像在深夜对自己说话。",
            scene="独处，灯光很暗，刚经历情绪低谷。",
            guidance=(
                "整体偏慢、偏轻；情绪克制，不刻意哭腔。\n"
                "- 语速与顿挫：慢，停顿偏多。\n"
                "- 气声与实声：气声略多，力度偏弱。\n"
