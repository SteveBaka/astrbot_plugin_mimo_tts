...
SUPPORTED_EMOTIONS: tuple[str, ...] = (
    "happy", "sad", "angry", "neutral", "whisper", "surprised",
    "excited", "gentle", "serious", "romantic", "fearful", "disgusted",
    "sarcastic", "nostalgic", "playful", "calm", "anxious", "proud",
    "tender", "lazy",
)
...
MIMO_VOICE_LIST: list[dict[str, str]] = [
    {"id": "mimo_default", "name": "MiMo-默认", "gender": "因集群而异", "style": "中国集群默认冰糖"},
...
TTS_PRESETS: dict[str, dict] = {
    "default": {
        ...
        "breath": False, "stress": False, "voice": "mimo_default",
    },
    "gentle_female": {
        "emotion": "gentle", "speed": 0.95, "pitch": 2,
        "breath": True, "stress": False, "voice": "冰糖",
    },
    "energetic": {
        "emotion": "excited", "speed": 1.2, "pitch": 1,
        "breath": False, "stress": True, "voice": "茉莉",
    },
    "news_anchor": {
        "emotion": "serious", "speed": 1.05, "pitch": 0,
        "breath": False, "stress": True, "voice": "苏打",
    },
    "bedtime_story": {
        "emotion": "gentle", "speed": 0.85, "pitch": 1,
        "breath": True, "stress": False, "voice": "茉莉",
    },
    "sad_comfort": {
        "emotion": "tender", "speed": 0.9, "pitch": -1,
        "breath": True, "stress": False, "voice": "白桦",
    },
    "dramatic": {
        "emotion": "angry", "speed": 1.1, "pitch": 2,
        "breath": False, "stress": True, "voice": "Dean",
    },
    "whisper_secret": {
        "emotion": "whisper", "speed": 0.8, "pitch": -2,
        "breath": True, "stress": False, "voice": "Chloe",
    },
}
